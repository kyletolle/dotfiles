...
" Declare theme name
let g:colors_name="hemisukyle"

"}}}
" The Colors -----------------------------------------------{{{
" Define reusable colors
let s:black=           { "gui": "#000000", "cterm": "16"  }
let s:veryNearlyBlack= { "gui": "#101010", "cterm": "16"  }
let s:nearlyBlack=     { "gui": "#181818", "cterm": "16"  }
let s:white=           { "gui": "#FFFFFF", "cterm": "231" }
let s:nearlyWhite=     { "gui": "#F8F8F8", "cterm": 240   }
...
let s:highlightGrey=   { "gui": "#252525", "cterm": "238" }
let s:highlightGreen=  { "gui": "#004200", "cterm": "238" }
" A lighter gree: #005F00
" A brown-green: #1C1F0F
" A dark green: #111F0F
" A weird green :#13260E 
let s:highlightPink=   { "gui": "#1F0F1F", "cterm": "134" }

let s:highlightOrange= { "gui": "#863A00", "cterm": "000" }
" A bright orange: #FF5900
let s:highlightPink=   { "gui": "#BD006C", "cterm": "000" }
" A pretty bright pink: #FF006C
" A more muted pink: #BD306C
...
let s:kyPink=          { "gui": "#FF4598", "cterm": "167" }
" A lighter pink: #FF007B
" A slightly darker pink: #D21180
...
let s:kyDarkBlue=      { "gui": "#0F1A1F", "cterm": "195" }
" 75% grey dark blue: #171C1F
" A bit darker blue: #00151F
" A lighter blue: #003D57
" A smidge lighter blue: #00293B
" Still a dark blue : #001523
" A darker blue: #091829
let s:kyBrightBlue=    { "gui": "#3B93FF", "cterm": "000" }
" Lighter blue: #0073FF
" A medium blue: #004598
...
if &background=="dark"
  ...
  let s:accent3=s:kyPink
	...
	let s:faintRed=s:kyPink
  "let s:faintRed=s:highlightPink
